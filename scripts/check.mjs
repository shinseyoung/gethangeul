...
for (const input of ['scripts/matcher.check.ts', 'scripts/surname.check.ts', 'scripts/pair.check.ts', 'scripts/traits.check.ts', 'scripts/kdrama.check.ts', 'scripts/fortune.check.ts', 'scripts/typography.check.ts', 'scripts/roman.check.ts']) {
